...
<div class="flex min-h-screen">
    ...
    <div class="flex-1 bg-gray-100 p-6 lg:p-10 flex items-center justify-center">
        <div class="bg-white p-6 rounded-lg shadow max-w-xl w-full mx-auto">
            <h1 class="text-2xl font-semibold text-gray-800 mb-6">Your Account Settings</h1>
            <form method="POST" action="{{ route('admin.settings.update') }}">
                ...
                <div class="flex justify-end">
                    <button type="submit" class="py-2 px-4 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700">Save Changes</button>
                </div>
            </form>
        </div>
    </div>
