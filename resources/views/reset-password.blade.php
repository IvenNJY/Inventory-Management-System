      ...
      <form method="POST" action="{{ route('password.update') }}">
        ...
        <div class="grid gap-y-4">
          ...
          <div>
            ...
            <p class="text-xs text-gray-500 mt-2">8 at least characters required</p>
          </div>
          ...
          <button type="submit" 
          class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700">Reset Password</button>
        </div>
